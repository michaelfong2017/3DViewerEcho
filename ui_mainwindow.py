...
"background-color: rgb(255, 255, 255, 0);")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, -431, 753, 961))
        ...
        sizePolicy2.setHeightForWidth(self.gridWidget.sizePolicy().hasHeightForWidth())
        self.gridWidget.setSizePolicy(sizePolicy2)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_16.sizePolicy().hasHeightForWidth())
        self.pushButton_16.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_18.sizePolicy().hasHeightForWidth())
        self.pushButton_18.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_20.sizePolicy().hasHeightForWidth())
        self.pushButton_20.setSizePolicy(sizePolicy5)
